...
Title = "[Y] To Toggle The GUI";
Text = "Thank You for using my GUI I Updated Most of the Broken Functions <3, [Y] also closes the GUI";
Duration = 15;
})
...
game.StarterGui:SetCore("SendNotification", {
Title = "Hehe";
Text = "Anti-Afk Ran -EvenPast#1133"; 
Duration = 10; })
print("Anti-AFK Ran")
end
...
Xcom911.Name = "Xcom911"
Xcom911.Parent = game.CoreGui
...
local function bro()
	...
	while wait(0.1)do
	    script1.Parent.BackgroundColor3=Color3.fromHSV(zigzag(counter),1,1)
		counter = counter + 0.001
		script2.Parent.BorderColor3=Color3.fromHSV(zigzag(counter),1,1)
		counter = counter + 0.001
		script3.Parent.BorderColor3=Color3.fromHSV(zigzag(counter),1,1)
		counter = counter + 0.001
		script4.Parent.BorderColor3=Color3.fromHSV(zigzag(counter),1,1)
		counter = counter + 0.001
		script5.Parent.BorderColor3=Color3.fromHSV(zigzag(counter),1,1)
		counter = counter + 0.001
		script6.Parent.BorderColor3=Color3.fromHSV(zigzag(counter),1,1)
		counter = counter + 0.001
		script7.Parent.BorderColor3=Color3.fromHSV(zigzag(counter),1,1)
		counter = counter + 0.001
		script8.Parent.BackgroundColor3=Color3.fromHSV(zigzag(counter),1,1)
		script9.Parent.TextColor3=Color3.fromHSV(zigzag(counter),1,1)
		script10.Parent.TextColor3=Color3.fromHSV(zigzag(counter),1,1)
		script11.Parent.TextColor3=Color3.fromHSV(zigzag(counter),1,1)
		script12.Parent.TextColor3=Color3.fromHSV(zigzag(counter),1,1)
		script13.Parent.TextColor3=Color3.fromHSV(zigzag(counter),1,1)
		script14.Parent.TextColor3=Color3.fromHSV(zigzag(counter),1,1)
		script15.Parent.TextColor3=Color3.fromHSV(zigzag(counter),1,1)
		script16.Parent.TextColor3=Color3.fromHSV(zigzag(counter),1,1)
		script17.Parent.TextColor3=Color3.fromHSV(zigzag(counter),1,1)
		script18.Parent.TextColor3=Color3.fromHSV(zigzag(counter),1,1)
		script19.Parent.TextColor3=Color3.fromHSV(zigzag(counter),1,1)
		script20.Parent.TextColor3=Color3.fromHSV(zigzag(counter),1,1)
		script21.Parent.TextColor3=Color3.fromHSV(zigzag(counter),1,1)
		script22.Parent.TextColor3=Color3.fromHSV(zigzag(counter),1,1)
		script23.Parent.TextColor3=Color3.fromHSV(zigzag(counter),1,1)
		script24.Parent.TextColor3=Color3.fromHSV(zigzag(counter),1,1)
		script25.Parent.TextColor3=Color3.fromHSV(zigzag(counter),1,1)
		script26.Parent.TextColor3=Color3.fromHSV(zigzag(counter),1,1)
		script27.Parent.TextColor3=Color3.fromHSV(zigzag(counter),1,1)
		script28.Parent.BackgroundColor3=Color3.fromHSV(zigzag(counter),1,1)
		script29.Parent.BackgroundColor3=Color3.fromHSV(zigzag(counter),1,1)
		script30.Parent.BackgroundColor3=Color3.fromHSV(zigzag(counter),1,1)
		script31.Parent.BackgroundColor3=Color3.fromHSV(zigzag(counter),1,1)
		script32.Parent.BackgroundColor3=Color3.fromHSV(zigzag(counter),1,1)
		script33.Parent.BackgroundColor3=Color3.fromHSV(zigzag(counter),1,1)
		script34.Parent.BackgroundColor3=Color3.fromHSV(zigzag(counter),1,1)
		script35.Parent.BackgroundColor3=Color3.fromHSV(zigzag(counter),1,1)
		script36.Parent.BackgroundColor3=Color3.fromHSV(zigzag(counter),1,1)
		script37.Parent.BackgroundColor3=Color3.fromHSV(zigzag(counter),1,1)
		script38.Parent.BackgroundColor3=Color3.fromHSV(zigzag(counter),1,1)
		script39.Parent.BackgroundColor3=Color3.fromHSV(zigzag(counter),1,1)
		script40.Parent.BackgroundColor3=Color3.fromHSV(zigzag(counter),1,1)
		script41.Parent.TextColor3=Color3.fromHSV(zigzag(counter),1,1)
		script42.Parent.TextColor3=Color3.fromHSV(zigzag(counter),1,1)
		script43.Parent.TextColor3=Color3.fromHSV(zigzag(counter),1,1)
		script44.Parent.TextColor3=Color3.fromHSV(zigzag(counter),1,1)
		script45.Parent.TextColor3=Color3.fromHSV(zigzag(counter),1,1)
		script46.Parent.TextColor3=Color3.fromHSV(zigzag(counter),1,1)
		script47.Parent.TextColor3=Color3.fromHSV(zigzag(counter),1,1)
		script48.Parent.TextColor3=Color3.fromHSV(zigzag(counter),1,1)
		script49.Parent.TextColor3=Color3.fromHSV(zigzag(counter),1,1)
		script50.Parent.TextColor3=Color3.fromHSV(zigzag(counter),1,1)
		script51.Parent.TextColor3=Color3.fromHSV(zigzag(counter),1,1)
		script52.Parent.TextColor3=Color3.fromHSV(zigzag(counter),1,1)
		script53.Parent.TextColor3=Color3.fromHSV(zigzag(counter),1,1)
		script54.Parent.BackgroundColor3=Color3.fromHSV(zigzag(counter),1,1)
		script55.Parent.BackgroundColor3=Color3.fromHSV(zigzag(counter),1,1)
		script56.Parent.BackgroundColor3=Color3.fromHSV(zigzag(counter),1,1)
		script57.Parent.BackgroundColor3=Color3.fromHSV(zigzag(counter),1,1)
		script58.Parent.BorderColor3=Color3.fromHSV(zigzag(counter),1,1)
	end
end
...
LocalPlayer.Text = "Maneuverability"
...
button1.Text = "Aquatic_+_InfOxygen"
...
button2.Text = "Jesus_Waterwalk_Mode"
...
button3.Text = "Invincible_+_Infjump"
...
button4.Text = "Speed_+_JumpPower"
...
spawndinotext.Text = "Hothead Megavore"
...
localptext.Text = "Made by EvenPast#1133"
...
Fly.Size = UDim2.new(0, 114, 0, 30)
Fly.Font = Enum.Font.Cartoon
Fly.Text = "Fire Loop TP Beams/Chests"
Fly.TextColor3 = Color3.new(0.611765, 0.611765, 0.611765)
...
AddThirst.Size = UDim2.new(0, 114, 0, 30)
AddThirst.Font = Enum.Font.Cartoon
AddThirst.Text = "Loop Add Thirst"
AddThirst.TextColor3 = Color3.new(0.611765, 0.611765, 0.611765)
AddThirst.TextColor3 = Color3.new(0.611765, 0.611765, 0.611765)
...
ClickTP.Size = UDim2.new(0, 114, 0, 30)
ClickTP.Font = Enum.Font.Cartoon
ClickTP.Text = "Pause Loop TP Beam/Chest"
ClickTP.TextColor3 = Color3.new(0.611765, 0.611765, 0.611765)
ClickTP.TextColor3 = Color3.new(0.611765, 0.611765, 0.611765)
...
SubtractHunger.Size = UDim2.new(0, 114, 0, 30)
SubtractHunger.Font = Enum.Font.Cartoon
SubtractHunger.Text = "My Favorite Shader"
SubtractHunger.TextColor3 = Color3.new(0.611765, 0.611765, 0.611765)
SubtractHunger.TextColor3 = Color3.new(0.611765, 0.611765, 0.611765)
...
TradingMap.Size = UDim2.new(0, 114, 0, 30)
TradingMap.Font = Enum.Font.Cartoon
TradingMap.Text = "Nifty Lighting (Use First)"
TradingMap.TextColor3 = Color3.new(0.611765, 0.611765, 0.611765)
TradingMap.TextColor3 = Color3.new(0.611765, 0.611765, 0.611765)
...
GallusIsland.Size = UDim2.new(0, 114, 0, 30)
GallusIsland.Font = Enum.Font.Cartoon
GallusIsland.Text = "Nifty Shaders (Use Second)"
GallusIsland.TextColor3 = Color3.new(0.611765, 0.611765, 0.611765)
GallusIsland.TextColor3 = Color3.new(0.611765, 0.611765, 0.611765)
...
eldertext2.Size = UDim2.new(0, 415, 0, 30)
eldertext2.Font = Enum.Font.Cartoon
eldertext2.Text = "Revamped Stats Replacement"
eldertext2.BackgroundColor3 = Color3.new(1, 1, 1)
eldertext2.BackgroundTransparency = 1
...
eldertext1.Size = UDim2.new(0, 336, 0, 30)
eldertext1.Font = Enum.Font.Cartoon
eldertext1.Text = "Revamped Elder Dinosaur"
eldertext1.TextColor3 = Color3.new(1, 1, 1)
eldertext1.BackgroundColor3 = Color3.new(1, 1, 1)
eldertext1.BackgroundTransparency = 1
...
Dex.Name = "creditstext7"
Dex.Parent = GUIHead
Dex.BackgroundColor3 = Color3.new(1, 1, 1)
Dex.BackgroundTransparency = 1
Dex.BorderColor3 = Color3.new(0.290196, 0.290196, 0.290196)
Dex.BorderSizePixel = 0
Dex.Position = UDim2.new(0, 0, 0, 0)
Dex.Size = UDim2.new(0, 795, 0, 483)
Dex.Image = "rbxassetid://8013269465"
Dex.ImageTransparency = 0.7
Dex.ScaleType = "Crop"
Dex.SliceScale = 10
...
TextDNAfarm.Text = "Make your Brachiosaurus 97% Young Adult and your Diplodocus baby 1% and hit fire da farm (Breaks in private servers)."
...
StartDNALoop.Size = UDim2.new(0, 114, 0, 30)
StartDNALoop.Font = Enum.Font.Cartoon
StartDNALoop.Text = "Fire Da DNA Farm"
StartDNALoop.TextColor3 = Color3.new(0.611765, 0.611765, 0.611765)
StartDNALoop.TextColor3 = Color3.new(0.611765, 0.611765, 0.611765)
...
if not _G.DNAFarmActive then
    game.StarterGui:SetCore("SendNotification", {
    Title = "DNA FARM GANG";
    Text = "Message : DNA Farm Paused"; 
    Duration = 5; })
end
if _G.DNAFarmActive then
    ...
    game.StarterGui:SetCore("SendNotification", {
    Title = "DNA FARM GANG";
    Text = "Anti-Afk Launched : DNA Farm Fired"; 
    Duration = 5; })
    print("Anti-AFK Ran")
end
